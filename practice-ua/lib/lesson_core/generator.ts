...
type Response_MultipleChoice_Func = ((dictionary: Dictionary, config: Config) => Response_MultipleChoice_Data) | undefined;
type ResponseWithImage_FreeText_Func = ((dictionary: Dictionary, config: Config) => any) | undefined;
type ResponseWithImage_MultipleChoice_Func = ((dictionary: Dictionary, config: Config) => any) | undefined;
type FillIn_FreeText_Func = ((dictionary: Dictionary, config: Config) => any) | undefined;
type FillIn_MultipleChoice_Func = ((dictionary: Dictionary, config: Config) => any) | undefined;
